...
const TOPIC_CONTENT: Record<string, {
  ...
  "Nevada Licensing Requirements (NRS 645, NAC 645)": {
    nrsRefs: "NRS 645.343 (salesperson: 120 hrs pre-licensing — updated 2023); NRS 645.330 (broker: 64 additional hrs + 2 yrs active experience); NRS 645.575–645.580 (disciplinary actions); NAC 645.440 (trust account requirements); NRS 645.633 (grounds for discipline); NRS 645.310 (earnest money handling); NRS 645.254 (document delivery within 5 days)",
    keyTerms: "Pre-licensing education (120 hrs salesperson / 64 additional hrs broker); Continuing education (24 hrs every 2 years); Trust account (separate account, no commingling); NRED (Nevada Real Estate Division); Broker supervision; Independent contractor vs. employee; Reciprocity",
    conceptSummary: "Nevada salesperson candidates must complete 120 hours of pre-licensing education, pass state and national exam portions, and be sponsored by a licensed broker. Brokers require 64 additional hours beyond salesperson requirements plus 2 years active experience. All licensees renew every 2 years with 24 hours CE. NRED enforces disciplinary actions including fines, suspension, and revocation. Commingling client funds with personal funds is always a violation regardless of duration or intent. Salespersons and broker-salespersons must deliver all original paperwork to their broker within 5 calendar days after contract execution.",
    examAlerts: "120 hrs pre-licensing (NOT 90 — statute updated 2023, NRS 645.343). CE = 24 hrs every 2 YEARS not annually. Commingling is ALWAYS a violation — even temporarily. Salesperson CANNOT operate independently — must be supervised. Trust account funds must NEVER be commingled. Reciprocity typically still requires Nevada-specific exam components.",
    commonMistakes: "Confusing 120-hr salesperson requirement with broker requirement; thinking temporary commingling is acceptable; assuming verbal agency agreement is sufficient; not knowing NRED can revoke, suspend, fine, AND require repayment of audit costs",
    ...
    examQuestionSamples: "How many hours of pre-licensing education does Nevada require for a salesperson? (120 hrs — NRS 645.343 updated 2023) | Commingling of client funds is: (Always a violation under NRS 645.633) | Nevada CE requirement: (24 hours every 2 years) | What is required for a broker license in addition to education? (2 years active experience)",
  },
...
1. **NRS/NAC** — Ground truth. Always cite specific statute numbers. The NRS references and specific values provided in the topic source material below (hours, timelines, deadlines) have been manually verified against current Nevada statute and must be used exactly as stated. Do NOT substitute values from your training data — if the source material says 120 hours, write 120 hours, not 90.
